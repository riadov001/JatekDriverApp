...
/**
 * Drives navigation based on auth state:
 * - Not signed in → /(auth)/login
 * - Signed in but no driver profile / not approved → /(onboarding)/driver-onboarding
 * - Signed in & approved → /(tabs)
 */
export function useAuthRouting() {
  ...
  useEffect(() => {
    ...
    const needsOnboarding =
      !user.driver || user.driver.status === "pending" || user.driver.status === "rejected";
