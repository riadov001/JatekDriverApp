  ...
  return (
    <View style={[styles.container, style]}>
      <MapView
        ...
        style={styles.map}
        initialRegion={{
          latitude: midLat || 33.5731,
          longitude: midLng || -7.5898,
      ...
      >
        ...
        {driverPos && (
          <Polyline
            coordinates={[driverPos, activeTarget]}
            strokeColor={toPickup ? colors.info : colors.primary}
            strokeWidth={4}
...
function fitMap(ref: React.RefObject<MapView | null>, driver: Coord, target: Coord) {
  try {
    ref.current?.fitToCoordinates([driver, target], {
